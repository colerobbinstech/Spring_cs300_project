...
gcc -c -fPIC -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux system5_msg.c -o edu_cs300_PassageProcessor.o
gcc -shared -o libsystem5msg.so edu_cs300_PassageProcessor.o -lc
